    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
      <div className="bg-base-100 text-base-content w-full max-w-md rounded-box shadow-xl p-8">
        ...
        <p className="text-sm font-mono mb-6 text-base-content/70">
          You're about to join {dao.name}, a DAO focused on{" "}
          {dao.description}. Confirm your participation.
        </p>

        <div className="flex gap-4">
          <button
            onClick={onConfirm}
            className="btn btn-primary flex-1 font-bold font-mono"
          >
            Confirm
          </button>
          <button
            onClick={onClose}
            className="btn btn-outline flex-1 font-bold font-mono"
          >
            Cancel
          </button>
        </div>
